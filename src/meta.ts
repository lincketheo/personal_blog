    ...
    posts: [
      {
        ...
        description: "c_specx - Common Systems Programming C Extensions - is a framework for major C applications. Here's a quick tour of what's in it. Over time, c_specx will grow to meet the needs of large scale applications (such as Numstore).",
      ...
      },
      {
        ...
        entry: () => import("@/blog/posts/8_intrusive-hash-table-in-c/IntrusiveHashTable.vue"),
      ...
      },
      {
        ...
        entry: () => import("@/blog/posts/7_a-simple-database-in-java/SimpleDatabaseJava.vue"),
      ...
      },
      {
        ...
        entry: () => import("@/blog/posts/6_pattern-recognition/PatternRecognition.vue"),
      ...
      },
      {
        ...
        description: "In this post, I will explore some interesting 5_paradoxes. I'll probably add to this post in the future, but for now, I just want this post to be about some silly little 5_paradoxes that have shown up in blog in the past.",
      ...
      },
      {
        ...
        entry: () => import("@/blog/posts/4_nn-systems-cantor/NNSystemsCantor.vue"),
      ...
      },
      {
        ...
        entry: () => import("@/blog/posts/2_building-a-bootloader/BuildingABootloader.vue"),
      ...
      },
      {
        ...
        entry: () => import("@/blog/posts/1_kotlin-error-handling/KotlinErrorHandling.vue"),
