  ...
  <main class="max-w-2xl mx-auto px-6 py-12">
    ...
    <header class="mb-12 border-b border-border pb-8">
      ...
      <p class="text-text/60 text-base leading-relaxed">
        ...
        <a href="https://github.com/lincketheo" class="text-red hover:text-red-hot underline">GitHub</a>.
    ...
    <div class="space-y-10">
      ...
      >
        ...
        <div class="flex items-start justify-between gap-4 px-6 pt-6 pb-4">
          <div>
            <h2 class="text-xl font-bold text-text font-serif">{{ program.name }}</h2>
            <span class="text-muted font-mono text-xs tracking-wide">v{{ program.version }}</span>
          </div>
          <a
              :href="program.repo"
              target="_blank"
        ...
        >
          <p class="font-mono text-xs tracking-widest uppercase text-muted mb-2">Blog Post</p>
          <a
        ...
        <!-- Downloads -->
        <div class="px-6 pb-5">
          <p class="font-mono text-xs tracking-widest uppercase text-muted mb-3">Download</p>
          <div class="flex flex-wrap gap-3">
            ...
            >
              <font-awesome-icon :icon="platformIcon[release.platform]" class="text-muted" />
              {{ release.label }}
            </a>
          </div>
        </div>
