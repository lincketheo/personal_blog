  ...
  <article class="max-w-4xl mx-auto px-6 py-12 font-serif">
    ...
    <section class="mb-10">
      ...
      <ul class="space-y-1 text-fg/70 leading-relaxed list-disc list-inside">
        ...
        <li>
          <a href="#section-1-2" class="underline hover:text-fg"
        ...
        <li>
          <a href="#section-6" class="underline hover:text-fg"
            >6.0.0 - The Open Protocol</a
          >
        </li>
        <li>
          <a href="#section-7" class="underline hover:text-fg"
    ...
    <section id="section-1" class="mb-10">
      ...
      <section id="section-1-1">
        ...
        >
          ...
          <li class="pl-3">
            <span class="text-fg font-semibold">Hidden from the user.</span>
            On the normal green path, keep the WAL deleted whenever possible.
          </li>
          <li class="pl-3">
            <span class="text-fg font-semibold">Bounded size.</span>
          ...
          <li class="pl-3">
            <span class="text-fg font-semibold">Future archival.</span>
    ...
    <section id="section-4" class="mb-10">
      ...
      <ol
        class="space-y-2 text-lg text-fg/70 leading-relaxed list-decimal list-inside marker:text-muted marker:font-mono marker:text-sm mb-4"
      >
        ...
        <li class="pl-3">
          <span class="font-semibold text-fg">DELETE</span> (atomic)
        </li>
