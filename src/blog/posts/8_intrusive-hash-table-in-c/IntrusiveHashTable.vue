  ...
  <article class="max-w-2xl mx-auto px-6 py-12 font-serif">
    <header class="mb-10">
      ...
      <p class="text-lg text-fg/70 leading-relaxed">
        ...
        I wrote previously. Reloading old code into your head is almost always
        worth it.
      </p>
    </header>
    ...
    <section class="mb-8">
      ...
      <p class="text-fg/75 leading-relaxed mb-4">
        ...
        <Code>free</Code> everywhere, and honestly that's not a bad thing. It's
        sort of what other languages do, but it's a lot harder in C.
      </p>
      <Definition term="malloc / free">
        <Code>malloc</Code> and <Code>free</Code> are the standard C library
      ...
      <p class="text-fg/75 leading-relaxed">
        ...
        internals, but at the end of the day C needs to know the size of an
        object before it can initialize it.
      </p>
    </section>
    ...
    <section class="mb-8">
      ...
      <figure class="my-6">
        ...
        <figcaption class="mt-2 text-sm text-muted italic text-center">
          Each bucket is the head of a linked list of entries that hash to the
          same slot.
        </figcaption>
      </figure>
      <Definition term="Hash collision">
        A collision occurs when two distinct keys hash to the same bucket. For
      ...
      <Definition term="O(n) vs. Θ(1)">
        ...
        on average. The distinction between O (upper bound) and Θ (tight bound)
    ...
    <section class="mb-8">
      ...
      <Definition term="Intrusive data structure">
        An intrusive data structure stores its bookkeeping nodes
      ...
      ><code class="font-mono text-sm text-fg/85 leading-relaxed">struct word_entry
{
    ...
    ((type *)((char *)(ptr) - offsetof(type, member)))</code></pre>
      <Definition term="offsetof">
        ...
        <Code>&lt;stddef.h&gt;</Code>) that returns the byte offset of
    ...
    <section class="mb-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
        <div class="border border-border rounded p-5">
          <h3
            class="font-mono text-xs tracking-widest uppercase text-muted mb-4"
          >
            Pros
          </h3>
          <ul class="space-y-3 text-fg/75 text-sm leading-relaxed">
            ...
            <li>
              ...
              <Code>container_of</Code> gets you back to your type cleanly. No
        ...
        <div class="border border-border rounded p-5">
          ...
          <ul class="space-y-3 text-fg/75 text-sm leading-relaxed">
            ...
            <li>
              ...
              it's still in the table and you have a dangling pointer with no
              warning.
            </li>
          </ul>
        </div>
